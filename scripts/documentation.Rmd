...
hist_steplength <- ggplot(frida_6, aes(x = stepmean, fill = mov_status))
...
This was followed by the evaluation of an appropriate threshold of stepmean. Sample data sets from three different wild boar movements were generated and evaluated in a histogram. With a binwidth of 10, we were able to see a clear decline in the first bins of stepmean. This lead to our interpretation that wild boars rest on the left side of the histogram and move on the right side.
