...
Furthermore it seems valid that about 75 % is not assigned to a nest or wallow since the criterias (month, day and area) are logical AND-linked. When a evaluation of the processed data is done, it becomes clear that already the daytime has a big impact on the assignment. For nests and wallows, about two third of all segments are not suitable as resting site.
...
```{r echo=FALSE, results='asis'}
summary(wildboar_lags$wallow_are)
```
