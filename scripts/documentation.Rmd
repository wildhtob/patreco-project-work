...
We will mainly use data that we have already used in the exercises. The basis is the wild boar movement dataset and its metadata. In addition, we will also use the raster and vector data provided on the environment (field and vegetation type). Additional data on land coverage may be required (e.g. area statistics, vegetation height), which would be obtained from swisstopo.
