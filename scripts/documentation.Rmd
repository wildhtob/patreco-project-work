...
Finding a In a second phase we defined the threshold of stepmean. For this stepmean of three wild boars were plotted in a histogram. We expected to see a clear decline in the first bins of stepmean since wild boars gather at spots and move often in a slow manner.
