...
Since wild boars usually rest at nests and wallows the parameter movement status builds the basement for further analysis. A clear distinction between *resting* and *moving* is made by the introduction of the variable *segment_trigger*. The apropriate level of this threshold is evaluated in a critical manner. Sample data sets from three different wild boar movements are generated and evaluated.
