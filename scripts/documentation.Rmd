...
Furthermore data from a field survey has been used. In this survey provides spatial information about the type of use during the investigated time. If an area was used for agriculture the planted crops is also given.
